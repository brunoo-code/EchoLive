const iconPaths = {
  ...
  smile: <><circle cx="8" cy="8" r="6" /><path d="M5.5 9.5a3.2 3.2 0 0 0 5 0M5.5 6.5h.1M10.5 6.5h.1" /></>,
  eye: <><path d="M1.8 8s2.2-4 6.2-4 6.2 4 6.2 4-2.2 4-6.2 4-6.2-4-6.2-4Z" /><circle cx="8" cy="8" r="1.8" /></>,
  eyeOff: <><path d="m2.5 2.5 11 11M6.6 4.2A7.1 7.1 0 0 1 8 4c4 0 6.2 4 6.2 4a10.5 10.5 0 0 1-2.1 2.6M4.2 5.1A10.2 10.2 0 0 0 1.8 8s2.2 4 6.2 4a6.8 6.8 0 0 0 2-.3" /></>,
